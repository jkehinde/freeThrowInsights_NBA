# R script template from  www.superdatascience.com 
...
# Convert Free Throw Attempt to a matrix
...
# This is the function we will use to create our plot much quicker 
...
# Check to see freethrows and freethrow attempts dont have any outliers 
myplot(FreeThrows, main = "freeThrows")
myplot(FreeThrowAttempts, main = "FreeThrowAttempts")
...
# Over the period from 2005 - 2015 Dwight on average had the highest freethrow
# attempts.
# Joe Johnson takes the least 3 throw attempt and the reason may be becauase 
...
# An insight we can make here is that Chris paul take very little freethrows but 
# he make the most. You could suggest to the coach that maybe he should be given
# more oppurtunities to shoot free throws 

# Another insight is that Dwight howard has a high fieldgoal% but low freethrow 
# accuracy, which may seem weird but looking at the Players playing style 
# You will see he only make 2 points shots so he is rare ever shooting
